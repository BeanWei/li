...
func (b *listactionrecordeditmodalBuilder) Body(elements ...view.Node) *listactionrecordeditmodalBuilder {
	b.Items(elements...)
	return b
}

func (b *listactionrecordeditmodalBuilder) Footer(elements ...view.Node) *listactionrecordeditmodalBuilder {
	b.Children(elements...)
	return b
}
