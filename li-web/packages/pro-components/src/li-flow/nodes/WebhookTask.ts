...
class WebhookTaskModel extends RectNodeModel {
  static extendKey = "WebhookTaskModel";
  setAttributes() {
    this.width = 90;
    this.height = 42;
    this.radius = 4;
...
class WebhookTaskView extends RectNode {
  static extendKey = "WebhookTaskNode";
  getShape(): any {
...
const WebhookTask = {
  ...
  view: WebhookTaskView,
  model: WebhookTaskModel,
};

export { WebhookTaskModel, WebhookTaskView };
